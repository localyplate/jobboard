...
<head>
    <title>{if $seo_title}{$seo_title}{if $current_category != 'home'} | {/if}{else}{$html_title}{if $current_category != 'home'} | {/if}{/if}{if $current_category != 'home'}{php} echo SITE_NAME;{/php}{/if}</title>
