...
">&laquo; <?php echo $this->_tpl_vars['translations']['header']['home']; ?>
            ...
            <?php if ($this->_tpl_vars['current_category'] != 'home' && $this->_tpl_vars['current_category'] != ''): ?>
            <h4><?php echo $this->_tpl_vars['translations']['header']['filter_jobs']; ?>
</h4>
            <ul>
                <li>
...
/week/"><?php echo $this->_tpl_vars['translations']['filter']['week']; ?>
                ...
                <li>
                    <?php if ($this->_tpl_vars['filter'] != 'month'): ?>
                        <a href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
<?php echo $this->_tpl_vars['URL_JOBS']; ?>
/<?php echo $this->_tpl_vars['current_category']; ?>
/month/"><?php echo $this->_tpl_vars['translations']['filter']['month']; ?>
</a>
                    <?php else: ?>
                        <strong><a href="#"><?php echo $this->_tpl_vars['translations']['filter']['month']; ?>
</a></strong>
                    <?php endif; ?>
                </li>
                <li>
