<?php /* Smarty version 2.6.26, created on 2014-02-26 01:01:55
...
<?php  echo ' Admin - '.SITE_NAME; ?></title>
...
">&larr; Back to site</a>
	...
	<?php if ($this->_tpl_vars['isAuthenticated'] == 1): ?>
    <div id="search">
        <form id="search_form" method="post" action="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
search/">
            <fieldset>
                <div>
