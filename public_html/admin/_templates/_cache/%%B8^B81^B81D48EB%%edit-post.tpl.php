<?php /* Smarty version 2.6.26, created on 2012-10-16 03:31:32
         compiled from edit-post.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'edit-post.tpl', 50, false),)), $this); ?>
...
"<?php endif; ?> />
						...
						<div class="group<?php if ($this->_tpl_vars['errors']['occupation']): ?> error<?php endif; ?>">
							<label for="occupation"><?php echo $this->_tpl_vars['translations']['publish']['occupation_label']; ?>
</label>
							<input type="text" name="occupation" id="occupation" size="50" value="<?php if ($this->_tpl_vars['job']['occupation']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['occupation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$_POST['occupation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
							<div class=""><?php echo $this->_tpl_vars['translations']['publish']['occupation_info']; ?>
</div>
						</div>
						<div class="group<?php if ($this->_tpl_vars['errors']['details']): ?> error<?php endif; ?>">
							<label for="details"><?php echo $this->_tpl_vars['translations']['publish']['details']; ?>
</label>
							<input type="text" name="details" id="details" size="50" value="<?php if ($this->_tpl_vars['job']['details']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['details'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$_POST['details'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
							<div class=""><?php echo $this->_tpl_vars['translations']['publish']['details_info']; ?>
</div>
						</div>
						<div class="group<?php if ($this->_tpl_vars['errors']['address']): ?> error<?php endif; ?>">
							<label for="address"><?php echo $this->_tpl_vars['translations']['publish']['address']; ?>
</label>
							<input type="text" name="address" id="address" size="100" value="<?php if ($this->_tpl_vars['job']['address']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['address'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$_POST['address'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
							<div class=""><?php echo $this->_tpl_vars['translations']['publish']['address_info']; ?>
</div>
						</div>
						<div class="group<?php if ($this->_tpl_vars['errors']['requ']): ?> error<?php endif; ?>">
							<label for="requ"><?php echo $this->_tpl_vars['translations']['publish']['requ']; ?>
</label>
							<input type="text" name="requ" id="requ" size="50" value="<?php if ($this->_tpl_vars['job']['requ']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['requ'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$_POST['requ'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
							<div class=""><?php echo $this->_tpl_vars['translations']['publish']['requ_info']; ?>
</div>
						</div>
						<div class="group<?php if ($this->_tpl_vars['errors']['wage']): ?> error<?php endif; ?>">
							<label for="wage"><?php echo $this->_tpl_vars['translations']['publish']['wage']; ?>
</label>
							<input type="text" name="wage" id="wage" size="50" value="<?php if ($this->_tpl_vars['job']['wage']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['wage'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$_POST['wage'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
							<div class=""><?php echo $this->_tpl_vars['translations']['publish']['wage_info']; ?>
</div>
						</div>
						...
						<div class="group<?php if ($this->_tpl_vars['errors']['description']): ?> error<?php endif; ?>">
							...
							<textarea name="description" id="description" class="mceEditor" cols="80" rows="15"><?php if ($this->_tpl_vars['job']['description']): ?><?php echo $this->_tpl_vars['job']['description']; ?>
