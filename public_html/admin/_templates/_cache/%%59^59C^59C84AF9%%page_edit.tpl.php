<?php /* Smarty version 2.6.26, created on 2014-02-26 01:37:17
...
" />
				...
				<div class="group_submit">
					<button type="submit" class="save"><span><?php if ($this->_tpl_vars['current_page']): ?>Save changes<?php else: ?>Save page<?php endif; ?></span></button>
				</div>
			</div>
		</div>
