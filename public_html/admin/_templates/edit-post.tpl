			...
			<div class="clearfix">
				<div class="left span2 block">
					...
					<div id="job_details" class="block_inner">
						...
						<div class="group{if $errors.occupation} error{/if}">
							<label for="occupation">{$translations.publish.occupation_label}</label>
							<input type="text" name="occupation" id="occupation" size="50" value="{if $job.occupation}{$job.occupation|escape}{else}{$smarty.post.occupation|escape}{/if}" />
						...
						<div class="group{if $errors.address} error{/if}">
							...
							<input type="text" name="address" id="address" size="100" value="{if $job.address}{$job.address|escape}{else}{$smarty.post.address|escape}{/if}" />
